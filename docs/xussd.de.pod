...
Dialogfenster für USSD-Abfrage und PIN an, dann einen
Fortschrittsbalken und zu guter Letzt ein Infofenster mit dem
...
und zenity un verwendet das verfügbare Werkzeug.
